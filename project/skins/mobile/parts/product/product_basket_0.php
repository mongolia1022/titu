...
#prototal .totalprice { color:#f30; font-size:18px; font-weight:bold;}
...
<div id="mycart"> <span id="mycarttitle">我的购物车</span>
  ...
  <?php if($flag){ ?>
  <div id="prototal"> <span>商品总数：</span><span class="totalnum" id="totalnum"><?php echo $num; ?></span><span>件，</span> <span>总价：</span><span class="totalprice" id="totalprice"><?php echo $price; ?></span><span>元RMB</span> </div>
  <?php } ?>
  <div id="nextbutton"> 
