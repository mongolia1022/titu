...
#piclist ul li{ list-style:none; float:left; background:url(<?php echo $tag['path.skin']; ?>res/images/probox_bg3.gif) 10px 6px no-repeat; width:195px; padding:20px 0 0 25px; height:190px;}
#piclist ul li img{ width:172px; height:129px;}
#piclist ul li h5{ font-size:12px; font-family:"微软雅黑"; padding:25px 0 10px 10px;display:block;}
