...
var so = new SWFObject("<?php echo $tag['path.skin']; ?>res/swf/CuPlayerMiniV20_Black_S.swf","CuPlayer","214","154","9","#000000");
...
so.addVariable("CuPlayerWidth","214");
so.addVariable("CuPlayerHeight","154");
...
<?php }else{?>
<embed src="<?php echo $data['filePath']?>" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" wmode="opaque" width="214" height="154"></embed>
<?php }?>