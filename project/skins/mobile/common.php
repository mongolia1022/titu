...
<body>
  <style>
  <?php
  $display=$params['action']=='view'?'#leel{display:none;}':'#leev{display:none;}';
  echo $display;
  ?>
  </style>
<!--头部{-->
<header class="om-header" id="leel"> <a href="javascript:;" id="top_menu" class="menu"></a>
  <div class="title"><?php echo sys_menu_info("title",true)?></div>
  <div style="display: none;" id="top_menu_section" class="menu-section">
    <div class="close"><a id="top_menu_close" href="javascript:;"></a></div>
    <ul name="top-nav" class="top-nav">
      <?php nav_sub(0,1,0);?>
    </ul>
  </div>
</header>
...
<section class="mbody">
  <div class="om-page-detail">
    <h1 class="title"><?php echo sys_menu_info("title",false)?></h1>
    <?php sys_parts()?>
  </div>
</section>
