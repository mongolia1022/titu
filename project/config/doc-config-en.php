<?php
//数据库配置字段
define('DB_HOSTNAME','tituweb.dot.vip');
define('DB_USER','tituweb');
define('DB_PASSWORD','titu808');
define('DB_DBNAME','tituweb');
...
//系统开始运行时间
define('doccmsbirthday','2016-12-27');//此处如无需要请不要随意更改，否则将无法正常运行
//编辑器
...
define('productWidth','288');
define('productHight','288');
